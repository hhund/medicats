...
@XmlType(propOrder = { "oid", "dictionary", "code", "label", "type", "links" })
public class OpsNodeDto extends NodeDto
{
	...
	public OpsNodeDto(Collection<? extends Link> links, String oid, String dictionary, String code, String name,
			String type)
	{
