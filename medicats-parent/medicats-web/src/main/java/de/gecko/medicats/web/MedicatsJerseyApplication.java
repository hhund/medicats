...
@ApplicationPath("/")
public final class MedicatsJerseyApplication extends ResourceConfig
{
	private static final Logger logger = LoggerFactory.getLogger(MedicatsJerseyApplication.class);

	@Inject
	public MedicatsJerseyApplication(ServletContext servletContext)
	{
