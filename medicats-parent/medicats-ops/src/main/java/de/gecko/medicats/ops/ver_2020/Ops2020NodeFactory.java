package de.gecko.medicats.ops.ver_2020;
...
public class Ops2020NodeFactory extends AbstractClaMLOpsNodeFactory implements OpsNodeFactory
{
	private final ZipSource clamlZip = new ZipSource(ZipSource.getBasePath(), "ops2020syst-claml.zip", 535251843L);
	private final ZipSource ueberlZip = new ZipSource(ZipSource.getBasePath(), "ops2020syst-ueberl.zip", 2701313839L);
	...
	private final FileSource clamlXml = new FileSource(clamlZip, "Klassifikationsdateien",
			"ops2020syst_claml_20191018.xml");
	private FileSource transitionFile = new FileSource(ueberlZip, "Klassifikationsdateien",
			"ops2020syst_umsteiger_2019_2020.txt");
	private FileSource systFile = new FileSource(ueberlZip, "Klassifikationsdateien", "ops2020syst.txt");
	...
	{
		return new Ops2020NodeWalker(getRootNode());
	}
